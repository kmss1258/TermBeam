        ...
        >
          ...
          >
            ...
            <svg width={16 * scale} height={12 * scale} viewBox="0 0 16 12">
              ...
              <path d="M4.7 7.9a4.5 4.5 0 016.6 0" stroke="#fff" strokeWidth="1.3" fill="none" strokeLinecap="round" />
              <path d="M2 5.2a8 8 0 0112 0" stroke="#fff" strokeWidth="1.3" fill="none" strokeLinecap="round" />
            </svg>
            {/* Battery */}
            <svg width={27 * scale} height={12 * scale} viewBox="0 0 27 12">
              <rect x="0" y="0.5" width="23" height="11" rx="2.5" stroke="rgba(255,255,255,0.35)" strokeWidth="1" fill="none" />
